...
class Blog extends Validate
{
	...
	protected $rule = [
        ...
        'article_title|文章分类标题'=>'require|unique:article_article|max:15',
        'article_user|文章作者名称'=>'require|max:200',
    ...
    protected $scene = [
        ...
        'article_search'=>['article_createtimemin','article_createtimemax','article_searchtitle'],
